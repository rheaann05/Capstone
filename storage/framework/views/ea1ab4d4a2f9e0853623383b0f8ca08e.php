...
<div class="p-4 sm:p-6 lg:p-10 max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="<?php echo e(route('tenant.property-types.create')); ?>" wire:navigate class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-500 text-white text-sm font-semibold shadow-lg shadow-brand-500/20 transition hover:scale-105">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div class="glass-card !rounded-xl p-5">
            ...
            <p class="text-2xl font-bold text-amber-400"><?php echo e($this->stats['global']); ?></p>
        </div>
        <div class="glass-card !rounded-xl p-5">
            <p class="text-sm text-brand-400">Your Custom Types</p>
            <p class="text-2xl font-bold text-brand-400"><?php echo e($this->stats['custom']); ?></p>
        </div>
    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-white/5 transition-colors">
                            <td class="px-4 sm:px-6 py-4">
                                <span class="font-medium text-white"><?php echo e($type->name); ?></span>
                            </td>
                            <td class="px-4 sm:px-6 py-4">
                            ...
                            <td class="px-4 sm:px-6 py-4 text-center">
                                <span class="text-sm text-white/60"><?php echo e($type->properties_count); ?></span>
                            </td>
                            <td class="px-4 sm:px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($type->tenant_id)): ?>
                                        <a href="<?php echo e(route('tenant.property-types.edit', $type->id)); ?>" wire:navigate class="p-1.5 text-brand-400 hover:text-white hover:bg-brand-500/20 rounded-lg transition" title="Edit">
