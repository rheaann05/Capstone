...
<div class="p-6 sm:p-10 max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('superadmin.property-types.create')); ?>" wire:navigate class="bg-amber-500 hover:bg-amber-600 text-white font-medium py-2.5 px-5 rounded-lg shadow-sm transition flex items-center gap-2">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-indigo-600"><?php echo e($this->stats['custom']); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $filterScope !== 'all' || $filterTenant): ?>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 transition-colors <?php echo e(in_array($type->id, $expandedTypes) ? 'bg-slate-50' : ''); ?>">
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <?php else: ?>
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700 border border-indigo-200">
                                        ...
                                        <?php echo e($type->tenant->name ?? 'Unknown'); ?>

                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <button wire:click="toggleExpand(<?php echo e($type->id); ?>)" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-slate-100 text-slate-700 hover:bg-slate-200 transition">
                                    <?php echo e($type->properties_count); ?> <?php echo e(Str::plural('property', $type->properties_count)); ?>

                                    <svg class="w-3 h-3 transition-transform <?php echo e(in_array($type->id, $expandedTypes) ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                                </button>
                            </td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_null($type->tenant_id)): ?>
                                        <a href="<?php echo e(route('superadmin.property-types.edit', $type->id)); ?>" wire:navigate class="p-1.5 text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Edit global standard">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                        </a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <button wire:click="delete(<?php echo e($type->id); ?>)" 
                                            wire:confirm="<?php echo e(is_null($type->tenant_id) ? 'Delete this global standard? It will be removed for all tenants.' : 'Delete this tenant custom type?'); ?>" 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($type->id, $expandedTypes)): ?>
                            <tr>
                                <td colspan="4" class="px-6 py-4 bg-slate-50 border-t border-slate-200">
                                    <div class="pl-4">
                                        <h4 class="text-sm font-semibold text-slate-700 mb-3">Properties using "<?php echo e($type->name); ?>"</h4>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type->properties->count() > 0): ?>
                                            <div class="grid grid-cols-1 gap-2">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $type->properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <div class="flex items-center justify-between p-2 bg-white rounded-lg border border-slate-200">
                                                        <div>
                                                            <span class="font-medium text-slate-800"><?php echo e($property->name); ?></span>
                                                            <span class="text-xs text-slate-500 ml-2">(<?php echo e($property->tenant->name ?? 'Unknown'); ?>)</span>
                                                        </div>
                                                        <span class="text-xs px-2 py-1 rounded-full <?php echo e($property->status === 'available' ? 'bg-green-100 text-green-700' : ($property->status === 'occupied' ? 'bg-amber-100 text-amber-700' : 'bg-red-100 text-red-700')); ?>">
...
</div><?php /**PATH C:\laragon\www\Capstone\storage\framework/views/livewire/views/a50cfb6d.blade.php ENDPATH**/ ?>